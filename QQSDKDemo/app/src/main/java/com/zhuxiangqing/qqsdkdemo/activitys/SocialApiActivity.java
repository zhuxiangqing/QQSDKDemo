...
import com.zhuxiangqing.qqsdkdemo.GetAskGiftParamsDialog;
import com.zhuxiangqing.qqsdkdemo.GetGradeParamsDialog;
import com.zhuxiangqing.qqsdkdemo.GetInviteParamsDialog;
import com.zhuxiangqing.qqsdkdemo.GetPkBragParamsDialog;
import com.zhuxiangqing.qqsdkdemo.GetReactiveParamsDialog;
import com.zhuxiangqing.qqsdkdemo.GetStoryParamsDialog;
import com.zhuxiangqing.qqsdkdemo.GetVoiceParamsDialog;
...
public class SocialApiActivity extends BaseActivity implements OnClickListener {
	...
	private void onClickInvite() {
		if (mTencent.isReady()) {
		    if (mNeedInputParams == 1) {
                new GetInviteParamsDialog(this, new GetInviteParamsDialog.OnGetInviteParamsCompleteListener() {
    ...
    private void showVoiceDialog(){
        new GetVoiceParamsDialog(this, new GetVoiceParamsDialog.OnGetVoiceParamsCompleteListener() {
